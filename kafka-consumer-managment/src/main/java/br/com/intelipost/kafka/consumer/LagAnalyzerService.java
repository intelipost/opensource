...
public class LagAnalyzerService {
    ...
    public LagAnalyzerService(
    		@Value("${spring.kafka.properties.bootstrap.servers}") String bootstrapServerConfig) {
    ...
    private KafkaConsumer<Object, Object> getKafkaConsumer(String bootstrapServerConfig) {
